...
const appleBentoDark: SlideDocument = {
  ...
  cards: [
    ...
    { id: "t1-img1", type: "image", grid: { x: 0, y: 0, w: 2, h: 2 },
      content: { src: "/template-images/apple-bento-dark-t1-img1-four-colors.png", fit: "cover",
    ...
    { id: "t1-img2", type: "image", grid: { x: 8, y: 0, w: 4, h: 2 },
      content: { src: "/template-images/apple-bento-dark-t1-img2-center-stage-camera.png", fit: "cover",
...
const pixelLight: SlideDocument = {
  ...
  cards: [
    ...
    { id: "t2-img1", type: "image", grid: { x: 0, y: 0, w: 4, h: 2 },
      content: { src: "/template-images/pixel-light-t2-img1-video-boost.png", fit: "cover",
    ...
    { id: "t2-img2", type: "image", grid: { x: 7, y: 0, w: 5, h: 2 },
      content: { src: "/template-images/pixel-light-t2-img2-matte-finish.png", fit: "cover",
    ...
    { id: "t2-img3", type: "image", grid: { x: 8, y: 4, w: 4, h: 2 },
      content: { src: "/template-images/pixel-light-t2-img3-pro-controls.png", fit: "cover",
...
const developerKeynoteLight: SlideDocument = {
  ...
  cards: [
    ...
    { id: "t6-img1", type: "image", grid: { x: 9, y: 0, w: 3, h: 2 },
      content: { src: "/template-images/developer-keynote-light-t6-img1-visionos.png", fit: "cover",
...
const airpodsLight: SlideDocument = {
  ...
  cards: [
    ...
    { id: "t7-img1", type: "image", grid: { x: 0, y: 2, w: 4, h: 2 },
      content: { src: "/template-images/airpods-light-t7-img1-best-fitting.png", fit: "cover",
